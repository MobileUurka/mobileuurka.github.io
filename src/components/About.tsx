...
const About = () => {
    return (
        <div className='w-[90%] mx-auto grid grid-cols-1 lg:grid-cols-[50%_50%] mb-[10vh] lg:mb-[20vh]'>
            <div className='w-full overflow-hidden relative mb-4 lg:mb-0 lg:w-[90%] bg-white rounded-4xl aspect-square'>
                <img
                    src={mac}
                    alt=""
            ...
            <div className='w-full lg:w-[90%] ml-[5%] flex flex-col justify-center'>
                ...
                <div className='w-[90%] lg:w-[85%] flex flex-row items-center gap-3 bg-white py-4 px-4 mt-6 rounded-lg'>
                    <div className='w-1.5 h-1.5 rounded-[50%] bg-primary'></div>
                    <div className='text-[#676767]'>Analyzing patient data</div>
                </div>
                <div className='w-[90%] lg:w-[85%] flex flex-row items-center gap-3 bg-white py-4 px-4 mt-2 rounded-lg'>
                    <div className='w-1.5 h-1.5 rounded-[50%] bg-primary'></div>
